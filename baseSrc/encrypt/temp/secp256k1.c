...
rustsecp256k1_v0_4_0_context* rustsecp256k1_v0_4_0_context_create(unsigned int flags) {
    size_t const prealloc_size = rustsecp256k1_v0_4_0_context_preallocated_size(flags);
    rustsecp256k1_v0_4_0_context* ctx = (rustsecp256k1_v0_4_0_context*)checked_malloc(&default_error_callback, prealloc_size);
    if (EXPECT(rustsecp256k1_v0_4_0_context_preallocated_create(ctx, flags) == NULL, 0)) {
        free(ctx);
        return NULL;
    }
...
rustsecp256k1_v0_4_0_context* rustsecp256k1_v0_4_0_context_clone(const rustsecp256k1_v0_4_0_context* ctx) {
    rustsecp256k1_v0_4_0_context* ret;
    size_t prealloc_size;

    VERIFY_CHECK(ctx != NULL);
    prealloc_size = rustsecp256k1_v0_4_0_context_preallocated_clone_size(ctx);
    ret = (rustsecp256k1_v0_4_0_context*)checked_malloc(&ctx->error_callback, prealloc_size);
    ret = rustsecp256k1_v0_4_0_context_preallocated_clone(ctx, ret);
    return ret;
}

void rustsecp256k1_v0_4_0_context_destroy(rustsecp256k1_v0_4_0_context* ctx) {
    if (ctx != NULL) {
